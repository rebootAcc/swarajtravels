          ...
          {Array.from({ length: 3 }).map((_, key) => (
            ...
            >
              ...
              <p className="text-sm md:text-xl">
                Our family vacation was an unforgettable experience, thanks to
                your exceptional service! From seamless bookings to personalized
                itineraries, everything was perfectly planned. The
                accommodations were top-notch, and the guided tours were
                informative and fun. We felt cared for every step of the way.
                Highly recommend for stress-free and memorable travels!
              </p>
