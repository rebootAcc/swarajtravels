...
export default function HomeStaticService() {
  ...
  const staticServices = [
    {
      ...
      img: "/staticsites/car rental.jpg",
      cardMain: "Car Rental Service",
      cardSub: "Get Best Price",
    },
    {
      heading: "Bike Services",
      img: "/staticsites/bike rental.jpg",
      cardMain: "Solo Bike Rental",
      cardSub: "Get Best Price",
    },
    {
      heading: "Group Tour",
      img: "/staticsites/group bike rental.jpg",
      cardMain: "Group Bike Rental",
      cardSub: "Get Best Price",
    },
    {
      heading: "Flight Ticket",
      img: "/staticsites/flight ticket.jpg",
      cardMain: "Flight Ticket Service",
      cardSub: "Get Best Price",
    },
    {
      heading: "Rail Ticket",
      img: "/staticsites/rail ticket.jpg",
      cardMain: "Rail Ticket Service",
      cardSub: "Get Best Price",
    },
  ];
  return (
    <section className="p-4 sm:p-10 xlg:p-20 grid grid-cols-1 md:grid-cols-3 justify-center lg:justify-normal gap-4 lg:gap-8">
      {staticServices.map((service: any, index: number) => (
        <div key={index} className="flex flex-col gap-2">
          <h1 className="text-typeograph-1 text-center font-bold text-xl sm:text-2xl lg:text-3xl">
            {service.heading}
          </h1>
          <Card>
            ...
            <div className="inline-flex">
              <button
                ...
                className="text-base flex-1 py-3 overflow-hidden text-center rounded-b-xl lg:text-xl font-semibold text-white bg-secondary"
              >
                Book Now
              </button>
            </div>
